...
public:
	...
	GuiTest(gl::GraphicsContext * gl, input::InputController * inputController)
	{
		master = std::make_unique<gui::Master>(gl, inputController);
		...
		gui::W_Text b_text{ "Button", "arial", 16, gl::Color::BLACK, 0x00u };
