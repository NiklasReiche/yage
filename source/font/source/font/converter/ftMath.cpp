...
namespace font
{
    ...
    *****************************************/
    ...
    void distanceFunction(Grid &grid_in, Grid &grid_out,
                          int g_x_min, int g_x_max, int g_y_min, int g_y_max,
                          int searchRange, float clampRange)
    {
        // Generate Distance Field
        auto maxDist = (float) sqrt(
                (g_x_max - g_x_min) * (g_x_max - g_x_min) + (g_y_max - g_y_min) * (g_y_max - g_y_min));
    ...
    img::Image
    genDistanceFieldPerGlyph(img::Image &inputImage, std::map<unsigned char, TexMetrics> &glyphs, int searchRange,
                             float clampRange)
    {
        ...
        for (auto it = glyphs.begin(); it != glyphs.end(); ++it)
        {
            ...
            std::cout << "Processing Glyph " << "'" << c << "' - " << glyphCount << " of " << glyphs.size() << " ..."
                      << std::endl;
