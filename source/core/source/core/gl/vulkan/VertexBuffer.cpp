...
namespace yage::gl::vulkan
{
    ...
    void VertexBuffer::create_buffer(const VkDeviceSize size, const VkBufferUsageFlags usage,
    ...
    void VertexBuffer::copyBuffer(const VkBuffer source, const VkBuffer destination, const VkDeviceSize size)
    {
