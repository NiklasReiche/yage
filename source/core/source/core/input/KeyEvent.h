...
namespace yage::input
{
	...
	public:
		enum class Code
		{
			KEY_UNKNOWN, KEY_SPACE, KEY_APOSTROPHE, KEY_COMMA, KEY_MINUS, 
			...
			KEY_MOUSE_6, KEY_MOUSE_7, KEY_MOUSE_8
		};
		enum class Action
		{
			PRESS, RELEASE, REPEAT, UNKNOWN
		};

		KeyEvent(Code key, Action action);
